            ...
            <div className="container px-6 py-10 pt-20 mx-auto">
                <div className="lg:flex lg:items-center lg:-mx-10">
                    ...
                    <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                        <Image className="hidden mx-auto rounded-full lg:block shrink-0 w-96 h-96" src="/hamza-pic-2.png" alt="" width={384} height={384}/>
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(+92) coming-soon</span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">codewithhamzaofficial@gmail.com</span>
                            </p>
                        </div>
